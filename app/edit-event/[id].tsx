  ...
  const fetchEvent = async () => {
    try {
      ...
      setFormData({
        ...
        minPlayers: event.minPlayers?.toString() || "",
        ...
        <View style={styles.formGroup}>
          ...
          <View style={styles.statusButtons}>
            <TouchableOpacity
              style={[
                styles.statusButton,
                formData.status === "scheduled" && styles.activeStatusButton,
              ]}
              onPress={() => handleInputChange("status", "scheduled")}
            >
              <Text
                style={[
            ...
            <TouchableOpacity
              style={[
                styles.statusButton,
                formData.status === "cancelled" && styles.activeStatusButton,
              ]}
              onPress={() => handleInputChange("status", "cancelled")}
            >
              <Text
                style={[
                  styles.statusButtonText,
